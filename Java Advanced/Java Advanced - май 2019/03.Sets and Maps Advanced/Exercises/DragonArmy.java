...
public class DragonArmy {
    ...
    public static void main(String[] args) {
        ...
        dragons.entrySet().forEach(entry -> {
            ...
            avgDamage = aggregatedData[0] /(entry.getValue().size() * 1.00);
            avgHealth = aggregatedData[1] /(entry.getValue().size() * 1.00);
            avgArmor = aggregatedData[2] /(entry.getValue().size() * 1.00);
